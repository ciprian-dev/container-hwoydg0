...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hwoydg0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hwoydg0.containers.anotherwebservice.com/
...
```
git clone git@github.com:ciprian-dev/container-hwoydg0.git
cd container-hwoydg0
```
...
```
docker attach container-hwoydg0
```
